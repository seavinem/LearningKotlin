...
fun totalNumberOfEmployees(company: Company): Int {
    return company.departments.sumOf { it.employees.size }
}

fun averageAgeOfEmployees(company: Company): Int {
    return company.departments.sumOf { it -> it.employees.sumOf { employee -> employee.age } } / totalNumberOfEmployees(company)
}